...
module Jekyll
  ...
  class LocalizeTag < Liquid::Tag
    ...
    def render(context)
      ...
      if ((!site.translation_file_content.empty?) || (File.file?("#{site.source}/_i18n/translations.yml")))
        if (site.translation_file_content.nil? || site.translation_file_content.empty?)
          site.translation_file_content = YAML.load_file("#{site.source}/_i18n/translations.yml")
        end
